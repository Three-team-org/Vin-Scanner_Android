...
public class BottomSheetResultsFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton btnForward = v.findViewById(R.id.btn_forward);
        ...
        btnForward.setOnClickListener(v12 -> {
            Intent intent_info_activity = new Intent(getContext(), VinShowActivity.class);
            String str_result = bundle.getString(ARGUMENT_TEXT);
            intent_info_activity.putExtra("Result_VIN", str_result);

            startActivity(intent_info_activity);
//            ClipboardManager clipboardManager = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
//            ClipData clipData = ClipData.newPlainText("nonsense_data", bundle.getString(ARGUMENT_TEXT));
//            clipboardManager.setPrimaryClip(clipData);
//            Toast.makeText(context, R.string.copied_to_clipboard, Toast.LENGTH_SHORT).show();
